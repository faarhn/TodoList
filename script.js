    ...
    function render(task){
        ...
        let li = document.createElement("li");
         ...
         console.log(li.id)
            ...
            li.className = "px-4 py-2 mt-2 flex flex-wrap justify-between items-center font-semibold border-2 border-black rounded-xl gap-2 bg-white shadow"; 
        ...
        let del_btn = document.createElement("button");
         ...
         del_btn.textContent = "Delete";
          del_btn.className = "px-3 py-1 bg-red-500 text-white border-2 border-black rounded-xl hover:bg-red-600 transition"; 
